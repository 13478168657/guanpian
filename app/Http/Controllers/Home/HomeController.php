...
//        dd($data['priceNews']);
    ...
    public function hindex(Request $request){
        ...
        $data['thirdNews'] = Article::where('category_id',6)->where('status',3)->OrderBy('id','desc')->take(7)->get();
        ...
        $data['imageNews'] = Article::where('category_id',11)->where('status',3)->OrderBy('id','desc')->take(7)->get();
        $data['lunbo'] = Advertisement::where('position_id',4)->get();
